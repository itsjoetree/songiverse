...
import { MusicNoteBeamed, StarHalf, StarFill, Icon } from 'react-bootstrap-icons'
...
const Home = ({albums} : HomeProps) => {
  ...
  return (<>
    ...
    <FlexContainer
      ...
      <FlexContainer style={{alignItems: "center", justifyContent: "center"}} direction="column">
        <Text component="h1">
    ...
    <FlexContainer direction="column">
      ...
      <FlexContainer style={{alignSelf: "center"}}>
        {
          albums.map(album => <FlexContainer style={{gap: 2, alignItems: "center", alignContent: "center"}} direction="column" key={album.name}>
              <Image
                alt={`${album.name} by ${album.artist}`}
                src={album.imgSrc}
                width={150}
